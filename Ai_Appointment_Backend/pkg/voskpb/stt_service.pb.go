...
func (RecognitionSpec_AudioEncoding) EnumDescriptor() ([]byte, []int) {
	return file_stt_service_proto_rawDescGZIP(), []int{3, 0}
}
...
const file_stt_service_proto_rawDesc = "" +
	"\n" +
	"\x11stt_service.proto\x12\vvosk.stt.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x93\x01\n" +
	...
	"\fStatsService\x12@\n" +
	"\bGetStats\x12\x16.google.protobuf.Empty\x1a\x1a.vosk.stt.v1.StatsResponse\"\x00B+Z)Kaustubh-Upare/ai-appoint-back/pkg/voskpbb\x06proto3"
...
var file_stt_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_stt_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
func file_stt_service_proto_init() {
	...
	file_stt_service_proto_msgTypes[0].OneofWrappers = []any{
